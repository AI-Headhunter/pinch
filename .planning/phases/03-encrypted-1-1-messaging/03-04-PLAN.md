...
- Full Manual routing: message from a full_manual connection is stored with pending_human_review state
...
- Full Manual messages are surfaced in HEARTBEAT.md flow
